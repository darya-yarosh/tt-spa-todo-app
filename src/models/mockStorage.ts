...
const MOCK_PROJECTLIST: Project[] = [{
    ...
    tasks: [{
        ...
        number: 1,
        title: "Title of task",
        desc: "Description of the task. This description is very-very long, you can trust me.",
        dataCreated: new Date().toLocaleDateString('ru-RU'),
        workingHours: 40,
        dateEnded: "",
    ...
    },
    {
        ...
        number: 2,
        title: "Some task",
        desc: "This task is under development.",
        dataCreated: new Date().toLocaleDateString('ru-RU'),
        workingHours: 30,
        dateEnded: "",
